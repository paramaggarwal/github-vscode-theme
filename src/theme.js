function getTheme({ colors, name }) {
  return {
    ...
    colors: {
      ...
      "button.background": colors.green[4],
      "button.foreground": colors.white,
      "button.hoverBackground": colors.green[6],
      ...
      "activityBar.activeBorder": colors.red[2],
      ...
      "list.hoverBackground": colors.blue[1],
      "list.inactiveSelectionBackground": colors.gray[0],
      "list.activeSelectionBackground": colors.blue[2],
      ...
      "tab.activeBorderTop": colors.red[2],
